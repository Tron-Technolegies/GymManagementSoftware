...
const Members = () => {
    ...
    const filteredMembers = members
        .filter((member) => {
            ...
            // Single date filter
            if (selectedDate) {
                matchesDate = member.due_date === selectedDate;
            }
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="rounded-lg border border-slate-100 shadow-sm p-3 space-y-4">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                    ...
                    <input
                        ...
                        className="w-72 px-3 py-2 border border-slate-300 rounded-lg
                       focus:outline-none focus:ring-2 focus:ring-yellow-500"
                    />
                </div>


                {/* Row 2 - Financial Filters + Single Date */}
                <div className="flex flex-wrap items-end justify-between gap-4">

                    {/* Financial Period */}
                    <div className="flex flex-wrap items-center gap-2">

                        {["today", "monthly", "yearly", "custom"].map((option) => (
                            <button
                                key={option}
                                onClick={() => setPeriod(option)}
                                className={`px-4 py-2 rounded-lg text-sm font-medium transition ${period === option
                    ...
                    {/* Single Date Calendar - Right End */}
                            ...
                            >
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex gap-3 whitespace-nowrap">
                                        ...
                                        {["SUPER_ADMIN", "TENANT_ADMIN", "BRANCH_ADMIN"].includes(user?.role) && (
                                            <button
